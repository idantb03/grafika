...
void Demo::Render() {
	...
	DrawStove(this->depthmapShader);
	DrawSideStove(this->depthmapShader);
	DrawFrontStove(this->depthmapShader);
	...
	glActiveTexture(GL_TEXTURE1);
	glBindTexture(GL_TEXTURE_2D, depthMap);
	DrawStove(this->shadowmapShader);
	DrawSideStove(this->shadowmapShader);
	DrawFrontStove(this->shadowmapShader);
...
void Demo::DrawStove(GLuint shader)
{
	UseShader(shader);
...
void Demo::DrawSideStove(GLuint shader)
{
	UseShader(shader);
...
void Demo::DrawFrontStove(GLuint shader)
{
	UseShader(shader);
